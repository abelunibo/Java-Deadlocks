...
public class JGFRayTracerBench extends RayTracer implements JGFSection3 {
	...
	public void JGFapplication() {
		...
		RayTracerRunner thobjects[] = new RayTracerRunner[nthreads];
		Thread th[] = new Thread[nthreads];
		final TournamentBarrier br = new TournamentBarrier(nthreads);

		final RayTracerRunner r1 = new RayTracerRunner(1, width, height, br);
		final RayTracerRunner r2 = new RayTracerRunner(2, width, height, br);
...
class RayTracerRunner extends RayTracer  {
	...
	public RayTracerRunner(int id, int width, int height, TournamentBarrier br) {
		this.id = id;
		this.width = width;
		this.height = height;
		this.br = br;
