...
public class WaitableFloat extends SynchronizedFloat {
  ...
  public void whenEqual(float c, Thread action) throws InterruptedException {
    synchronized(lock_) {
   ...
   * The action is run with the synchronization lock held.
   **/
  public void whenNotEqual(float c, Thread action) throws InterruptedException {
    synchronized (lock_) {
      while (!(value_ != c)) lock_.wait();
      if (action != null) action.run();
    }
   ...
   * The action is run with the synchronization lock held.
   **/
  public void whenLessEqual(float c, Thread action) throws InterruptedException {
    synchronized (lock_) {
      while (!(value_ <= c)) lock_.wait();
      if (action != null) action.run();
    }
   ...
   * The action is run with the synchronization lock held.
   **/
  public void whenLess(float c, Thread action) throws InterruptedException {
    synchronized (lock_) {
      while (!(value_ < c)) lock_.wait();
      if (action != null) action.run();
    }
   ...
   * The action is run with the synchronization lock held.
   **/
  public void whenGreaterEqual(float c, Thread action) throws InterruptedException {
    synchronized (lock_) {
      while (!(value_ >= c)) lock_.wait();
      if (action != null) action.run();
    }
   ...
   * The action is run with the synchronization lock held.
   **/
  public void whenGreater(float c, Thread action) throws InterruptedException {
    synchronized (lock_) {
      while (!(value_ > c)) lock_.wait();
      if (action != null) action.run();
    }
