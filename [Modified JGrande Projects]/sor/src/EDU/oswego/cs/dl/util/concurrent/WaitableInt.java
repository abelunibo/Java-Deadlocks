...
public class WaitableInt extends SynchronizedInt {
  ...
  public void whenEqual(int c, Thread action) throws InterruptedException {
    synchronized(lock_) {
   ...
   * The action is run with the synchronization lock held.
   **/
  public void whenNotEqual(int c, Thread action) throws InterruptedException {
    synchronized (lock_) {
      while (!(value_ != c)) lock_.wait();
      if (action != null) action.run();
    }
   ...
   * The action is run with the synchronization lock held.
   **/
  public void whenLessEqual(int c, Thread action) throws InterruptedException {
    synchronized (lock_) {
      while (!(value_ <= c)) lock_.wait();
      if (action != null) action.run();
    }
   ...
   * The action is run with the synchronization lock held.
   **/
  public void whenLess(int c, Thread action) throws InterruptedException {
    synchronized (lock_) {
      while (!(value_ < c)) lock_.wait();
      if (action != null) action.run();
    }
   ...
   * The action is run with the synchronization lock held.
   **/
  public void whenGreaterEqual(int c, Thread action) throws InterruptedException {
    synchronized (lock_) {
      while (!(value_ >= c)) lock_.wait();
      if (action != null) action.run();
    }
   ...
   * The action is run with the synchronization lock held.
   **/
  public void whenGreater(int c, Thread action) throws InterruptedException {
    synchronized (lock_) {
      while (!(value_ > c)) lock_.wait();
      if (action != null) action.run();
    }
