...
public class FJTaskRunnerGroup implements Executor {
  ...
  **/
  ...
  public void execute(Thread r) throws InterruptedException {
  ...
  public void invoke(Thread r) throws InterruptedException {
  ...
  protected static final class InvokableFJTask extends FJTask {
    protected final Thread wrapped;
    protected boolean terminated = false;

    protected InvokableFJTask(Thread r) { wrapped = r; }
