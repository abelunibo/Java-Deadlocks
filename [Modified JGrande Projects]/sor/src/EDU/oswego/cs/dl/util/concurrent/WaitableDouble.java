...
public class WaitableDouble extends SynchronizedDouble {
  ...
  public void whenEqual(double c, Thread action) throws InterruptedException {
    synchronized(lock_) {
   ...
   * The action is run with the synchronization lock held.
   **/
  public void whenNotEqual(double c, Thread action) throws InterruptedException {
    synchronized (lock_) {
      while (!(value_ != c)) lock_.wait();
      if (action != null) action.run();
    }
   ...
   * The action is run with the synchronization lock held.
   **/
  public void whenLessEqual(double c, Thread action) throws InterruptedException {
    synchronized (lock_) {
      while (!(value_ <= c)) lock_.wait();
      if (action != null) action.run();
    }
   ...
   * The action is run with the synchronization lock held.
   **/
  public void whenLess(double c, Thread action) throws InterruptedException {
    synchronized (lock_) {
      while (!(value_ < c)) lock_.wait();
      if (action != null) action.run();
    }
   ...
   * The action is run with the synchronization lock held.
   **/
  public void whenGreaterEqual(double c, Thread action) throws InterruptedException {
    synchronized (lock_) {
      while (!(value_ >= c)) lock_.wait();
      if (action != null) action.run();
    }
   ...
   * The action is run with the synchronization lock held.
   **/
  public void whenGreater(double c, Thread action) throws InterruptedException {
    synchronized (lock_) {
      while (!(value_ > c)) lock_.wait();
      if (action != null) action.run();
    }
