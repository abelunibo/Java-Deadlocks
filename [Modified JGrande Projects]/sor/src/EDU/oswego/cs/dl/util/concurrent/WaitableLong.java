...
public class WaitableLong extends SynchronizedLong {
  ...
  public void whenEqual(long c, Thread action) throws InterruptedException {
    synchronized(lock_) {
   ...
   * The action is run with the synchronization lock held.
   **/
  public void whenNotEqual(long c, Thread action) throws InterruptedException {
    synchronized (lock_) {
      while (!(value_ != c)) lock_.wait();
      if (action != null) action.run();
    }
   ...
   * The action is run with the synchronization lock held.
   **/
  public void whenLessEqual(long c, Thread action) throws InterruptedException {
    synchronized (lock_) {
      while (!(value_ <= c)) lock_.wait();
      if (action != null) action.run();
    }
   ...
   * The action is run with the synchronization lock held.
   **/
  public void whenLess(long c, Thread action) throws InterruptedException {
    synchronized (lock_) {
      while (!(value_ < c)) lock_.wait();
      if (action != null) action.run();
    }
   ...
   * The action is run with the synchronization lock held.
   **/
  public void whenGreaterEqual(long c, Thread action) throws InterruptedException {
    synchronized (lock_) {
      while (!(value_ >= c)) lock_.wait();
      if (action != null) action.run();
    }
   ...
   * The action is run with the synchronization lock held.
   **/
  public void whenGreater(long c, Thread action) throws InterruptedException {
    synchronized (lock_) {
      while (!(value_ > c)) lock_.wait();
      if (action != null) action.run();
    }
