...
public class WaitableChar extends SynchronizedChar {
  ...
  public void whenEqual(char c, Thread action) throws InterruptedException {
    synchronized(lock_) {
   ...
   * The action is run with the synchronization lock held.
   **/
  public void whenNotEqual(char c, Thread action) throws InterruptedException {
    synchronized (lock_) {
      while (!(value_ != c)) lock_.wait();
      if (action != null) action.run();
    }
   ...
   * The action is run with the synchronization lock held.
   **/
  public void whenLessEqual(char c, Thread action) throws InterruptedException {
    synchronized (lock_) {
      while (!(value_ <= c)) lock_.wait();
      if (action != null) action.run();
    }
   ...
   * The action is run with the synchronization lock held.
   **/
  public void whenLess(char c, Thread action) throws InterruptedException {
    synchronized (lock_) {
      while (!(value_ < c)) lock_.wait();
      if (action != null) action.run();
    }
   ...
   * The action is run with the synchronization lock held.
   **/
  public void whenGreaterEqual(char c, Thread action) throws InterruptedException {
    synchronized (lock_) {
      while (!(value_ >= c)) lock_.wait();
      if (action != null) action.run();
    }
   ...
   * The action is run with the synchronization lock held.
   **/
  public void whenGreater(char c, Thread action) throws InterruptedException {
    synchronized (lock_) {
      while (!(value_ > c)) lock_.wait();
      if (action != null) action.run();
    }
