...
public class CyclicBarrier implements Barrier {
  ...
  protected Thread barrierCommand_ = null;
  ...
  public CyclicBarrier(int parties, Thread command) { 
  ...
  public synchronized Thread setBarrierCommand(Thread command) {
    Thread old = barrierCommand_;
    barrierCommand_ = command;
    return old;
  }
