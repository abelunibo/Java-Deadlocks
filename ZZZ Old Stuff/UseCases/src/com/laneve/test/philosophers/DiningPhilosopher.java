...
public class DiningPhilosopher extends Thread{
	...
	public static void main(String[] args) {
		...
		DiningPhilosopher d1 = new DiningPhilosopher(0,f2,f0); //Deadlock
		//DiningPhilosopher d1 = new DiningPhilosopher(0,f2,f0); //No Deadlock
		DiningPhilosopher d2 = new DiningPhilosopher(1,f0,f1); 
		DiningPhilosopher d3 = new DiningPhilosopher(2,f1,f2); 
